...
!function (e) {
    e.fn.imageUploader = function (t) {
        let n,
            i = {
                preloaded: [], imagesInputName: "images", preloadedInputName: "preloaded", label: "Drag & Drop files here or click to browse", extensions: [".jpg", ".jpeg", ".png"], mimes: ["image/jpeg", "image/png", "image/gif", "image/svg+xml"], maxSize: void 0, maxFiles: void 0
            }
            ,
            a = this,
            s = new DataTransfer;
        ...
        let o = function () {
            ...
            u = function (t, n) {
                ...
                let i = t.find(".uploaded").addClass('mb-4'),
                    a = t.find('input[type="file"]');
                e(n).each(function (e, t) {
                    s.items.add(t), i.append(l(URL.createObjectURL(t), s.items.length - 1), !1);
                });

                if (i.next(".add-more-images").length === 0) {
                    i.after('<div class="add-more-images"><i class="fa fa-plus-circle"></i> Upload More Images</div>');
                }

                a.prop("files", s.files);

                if (i.find(".uploaded-image").length === 0) {
                    i.next(".add-more-images").remove();
                }
                t.find('.upload-text').hide();

                t.find(".add-more-images").css({
                    "text-align": "center",
                    "position": "absolute",
                    "bottom": "10px",
                    "left": "0",
